...
export function UserNav() {
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <ThemeToggle buttonClassName="size-12 rounded-xl hover:rounded-lg transition-all duration-200 bg-background/50 border-border/50 hover:bg-accent hover:text-accent-foreground" />
      <DropdownMenu>
